...
lig1 = ppdb.pdbobj.PdbObj("./test/test_data/lig_conf_1.pdb")
lig2 = ppdb.pdbobj.PdbObj("./test/test_data/lig_conf_2.pdb")
pdb1 = ppdb.pdbobj.PdbObj("./test/test_data/3EIY.pdb")
pdb2 = ppdb.pdbobj.PdbObj("./test/test_data/3EIY.pdb")
pdb3 = ppdb.pdbobj.PdbObj("./test/test_data/1T48_995.pdb")
pdb4 = ppdb.pdbobj.PdbObj("./test/test_data/1T49_995.pdb")
